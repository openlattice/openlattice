...
class MaterializedEntitySetViewTest {
    private val logger: Logger = LoggerFactory.getLogger(MaterializedEntitySetViewTest::class.java)

    private val authorizedPropertyTypes = listOf(
    ...
    @Test
    fun testSelectPropertyTypesOfEntitySetColumnarQuery() {
        logger.info(
                "Materialized entity set view query:\n{}",
                selectPropertyTypesOfEntitySetColumnar(authorizedPropertyTypes.associateBy { it.id }, false)
        )
    }

    @Test
    fun testSelectPropertyTypesOfLinkingEntitySetColumnarQuery() {
        logger.info(
                "Materialized linking entity set view query:\n{}",
                selectPropertyTypesOfEntitySetColumnar(authorizedPropertyTypes.associateBy { it.id }, true)
        )
    }
