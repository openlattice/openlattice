...
import com.openlattice.data.storage.postgres.buildRedshiftPreparableFiltersSql
...
class PostgresEntityDataQueryServiceTest {
        ...
        logger.info(
            ...
            buildPostgresPreparableFiltersSql(
                        ...
                        filteredDataPageDefinition = FilteredDataPageDefinition(
                                ...
                                filter= StringValueFilter(setOf("foo")),
    ...
    fun testRedshfitQuery() {
        ...
        logger.info(
                "buildPreparableFiltersSqlForEntities query:\n{}",
                buildRedshiftPreparableFiltersSql(
                        propertyTypes.associateBy { it.id },
                        mapOf(),
                        EnumSet.of(MetadataOption.ENTITY_KEY_IDS),
                        entitySetIds = setOf(),
