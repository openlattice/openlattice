...
@Component
class MembersRemovedFromOrganizationEventStreamSerializer
    : SelfRegisteringStreamSerializer<MembersRemovedFromOrganizationEvent> {
    ...
    override fun getTypeId(): Int {
        return StreamSerializerTypeIds.MEMBERS_REMOVED_FROM_ORGANIZATION_EVENT.ordinal
    }

    override fun getClazz(): Class<out MembersRemovedFromOrganizationEvent> {
        return MembersRemovedFromOrganizationEvent::class.java
    }
}