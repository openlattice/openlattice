...
class MaterializedEntitySetsRefreshAggregator(
        val refreshableEntitySets: MutableSet<EntitySetAssemblyKey> = mutableSetOf()
    ...
    override fun combine(aggregator: Aggregator<*, *>) {
        if (aggregator is MaterializedEntitySetsRefreshAggregator) {
            this.refreshableEntitySets.addAll(aggregator.refreshableEntitySets)
        }
    }

    override fun aggregate(): Set<EntitySetAssemblyKey> {
        return refreshableEntitySets
    }
}