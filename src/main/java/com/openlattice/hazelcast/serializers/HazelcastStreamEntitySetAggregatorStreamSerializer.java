 ...
 */
@Component
public class HazelcastStreamEntitySetAggregatorStreamSerializer
        implements SelfRegisteringStreamSerializer<EntitySetAggregator> {
    ...
    @Override public int getTypeId() {
        return StreamSerializerTypeIds.HAZELCAST_STREAM_ENTITY_SET_AGGREGATOR.ordinal();
    }
