...
@JvmOverloads constructor(
        ...
        @JsonProperty(SerializationConstants.STORAGE_TYPE) val storageDriver: StorageDriver = StorageDriver.STANDARD,
    ...
    init {
        ...
        require((storageDriver == StorageDriver.STANDARD) || !isLinking) {
