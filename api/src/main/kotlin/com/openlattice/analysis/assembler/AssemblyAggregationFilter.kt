...
data class AssemblyAggregationFilter(
        ...
        @JsonProperty(SerializationConstants.SRC_AGGREGATIONS) val srcAggregations: List<Aggregation>,
        @JsonProperty(SerializationConstants.EDGE_AGGREGATIONS) val edgeAggregations: List<Aggregation>,
        @JsonProperty(SerializationConstants.DST_AGGREGATIONS) val dstAggregations: List<Aggregation>,
