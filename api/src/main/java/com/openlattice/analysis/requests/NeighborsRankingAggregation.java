...
/**
 * Model for top utilizer request
 */
public class NeighborsRankingAggregation {
    ...
    @JsonProperty( SerializationConstants.NEIGHBOR_AGGREGATIONS )
    public List<FilteredRankingAggregation> getNeighbors() {
        return neighbors;
    }

    @JsonProperty( SerializationConstants.SELF_AGGREGATIONS )
    public Set<WeightedRankingAggregation> getSelf() {
        return self;
    }
