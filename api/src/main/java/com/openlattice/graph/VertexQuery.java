 ...
 */
public class VertexQuery extends AbstractQuery {
    private final Map<UUID,Query> entitySetQueries;
    private final Map<UUID,Query> entityTypeIds;
    ...
    public VertexQuery(
            ...
            Set<UUID> entityTypeIds, Set<UUID> entityKeyIds ) {
