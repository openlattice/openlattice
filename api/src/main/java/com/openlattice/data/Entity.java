...
public class Entity {
    ...
    @JsonProperty( SerializationConstants.PROPERTIES_FIELD )
    public SetMultimap<FullQualifiedName, Object> getProperties() {
        return properties;
    }
}
