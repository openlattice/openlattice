...
class HierarchicalAgglomeratriveClusterer : Clusterer {
    ...
    override fun getNeighborhood(entityDataKey: EntityDataKey): PostgresIterable<EntityDataKey> {
        TODO("not implemented") //To change body of created functions use File | Settings | File Templates.
    }

    override fun getAdjacentClusters(entityDataKey: EntityDataKey): PostgresIterable<UUID> {
        TODO("not implemented") //To change body of created functions use File | Settings | File Templates.
    }

    override fun getCluster(entityDataKey: EntityDataKey): Optional<UUID> {
        TODO("not implemented") //To change body of created functions use File | Settings | File Templates.
    }
}