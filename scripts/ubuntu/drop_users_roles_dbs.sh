...
rm drop_roles.sql || :
rm drop_dbs.sql || :
PGPASSWORD=test psql -h localhost -p 5435 -U oltest postgres < drop_dbs_gen.sql | tail -n +3 | head -n -2 > drop_dbs.sql
...
PGPASSWORD=test psql -h localhost -p 5435 -U oltest postgres < drop_dbs.sql
